...
export class WorkbenchContextKeysHandler extends Disposable {
	...
	private panelDialogFreeModeContext: IContextKey<boolean>;
	...
	constructor(
		...
		this.panelDialogFreeModeContext = PanelDialogFreeModeContext.bindTo(
			this.contextKeyService,
		);
		this.panelDialogFreeModeContext.set(this.layoutService.isPanelInFreeMode());
	...
	private registerListeners(): void {
		...
		this._register(
			this.layoutService.onDidChangePartVisibility(() => {
				...
				this.panelMaximizedContext.set(this.layoutService.isPanelMaximized());
				this.panelDialogFreeModeContext.set(
					this.layoutService.isPanelInFreeMode(),
				);
				this.auxiliaryBarVisibleContext.set(
					this.layoutService.isVisible(Parts.AUXILIARYBAR_PART),
				);
