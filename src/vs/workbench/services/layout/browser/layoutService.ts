...
export interface IWorkbenchLayoutService extends ILayoutService {
	...
	/**
	 * Returns whether the panel is shown as a floating dialog (free mode) rather than docked (pinned mode).
	 */
	isPanelInFreeMode(): boolean;

	/**
	 * Toggles the panel between free (floating dialog) and pinned (docked at bottom) mode.
	 */
